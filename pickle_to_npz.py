...
argp = argparse.ArgumentParser(description="Re-format old cosmopower Pickle \
                                              files to npz files.")
argp.add_argument("filename", type=str,
                  help="The path to the .pkl file (without extension).")
argp.add_argument("-p", "--pca-nn", dest="PCAplusNN", action="store_true",
                  help="The network is a PCA+NN type network.")
