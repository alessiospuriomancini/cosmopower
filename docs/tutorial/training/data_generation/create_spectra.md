Now that we have our gird of parameters, we can use it to generate the corresponding spectra with e.g. the Boltzmann code [Class](https://arxiv.org/abs/1104.2933), available for download [here](https://github.com/lesgourg/class_public).
